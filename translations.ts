...
export const translations: Record<AppLanguage, any> = {
  en: {
    ...
    // Advanced Filters
    toggle_advanced: "Advanced Filters",
    placeholder_keywords: "Keywords (e.g. React, Python)",
    placeholder_industry: "Industry (e.g. Fintech, SaaS)",
    label_experience: "Experience Level",
    label_company_size: "Company Size",
    opt_exp_entry: "Entry Level",
    opt_exp_mid: "Mid-Senior",
    opt_exp_senior: "Senior / Lead",
    opt_exp_exec: "Executive",
    opt_size_startup: "Startup (<50)",
    opt_size_sme: "SME (50-250)",
    opt_size_corp: "Large Corp (250+)",
    any: "Any",
  ...
  fr: {
    ...
    // Advanced Filters
    toggle_advanced: "Filtres Avancés",
    placeholder_keywords: "Mots-clés (ex: React, Python)",
    placeholder_industry: "Secteur (ex: Fintech, SaaS)",
    label_experience: "Niveau d'expérience",
    label_company_size: "Taille d'entreprise",
    opt_exp_entry: "Junior / Débutant",
    opt_exp_mid: "Confirmé",
    opt_exp_senior: "Senior / Lead",
    opt_exp_exec: "Directeur / Exec",
    opt_size_startup: "Start-up (<50)",
    opt_size_sme: "PME (50-250)",
    opt_size_corp: "Grand Groupe (250+)",
    any: "Peu importe",
  ...
  zh: {
    ...
    // Advanced Filters
    toggle_advanced: "高级筛选",
    placeholder_keywords: "关键词 (例如: React, Python)",
    placeholder_industry: "行业 (例如: 金融科技, SaaS)",
    label_experience: "经验水平",
    label_company_size: "公司规模",
    opt_exp_entry: "初级 / 入门",
    opt_exp_mid: "中级 / 骨干",
    opt_exp_senior: "高级 / 专家",
    opt_exp_exec: "总监 / 高管",
    opt_size_startup: "初创公司 (<50)",
    opt_size_sme: "中小企业 (50-250)",
    opt_size_corp: "大型企业 (250+)",
    any: "不限",
